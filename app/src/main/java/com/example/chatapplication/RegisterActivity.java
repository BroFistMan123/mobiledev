...
public class RegisterActivity extends AppCompatActivity {
        ...
        tbn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(txt_username)|| TextUtils.isEmpty(txt_email )|| TextUtils.isEmpty(txt_password)){
                    ...
                    Toast.makeText(RegisterActivity.this, "Password must at least be 6 characters", Toast.LENGTH_SHORT).show();
    ...
    private void register(String userame, String email, String password){
